...
INSERT INTO products (name, description, image, price, age, id_category_product) VALUES
    ...
    ('Playmobil 123 Front Loader','El cargador frontal Playmobil 123 cuenta con una pala de trabajo en la parte delantera. El conjunto incluye un trabajador Playmobil 123 y una carga pesada para levantar. Playmobil 123 Front Loader 6775 es adecuado para mayores de 18 meses.', 'Playmobil_3_1.png', 3162, 1, 8),
    ...
    ('Playmobil 123 Ladder Unit Fire Truck','El Playmobil 123 Ladder Unit Fire Truck 6967 es el vehículo de emergencia perfecto para manos pequeñas. La unidad de escalera se puede girar 360 grados y se mueve hacia arriba y hacia abajo en tres posiciones. El oficial de bomberos puede sentarse en la cabina del conductor, al final de la plataforma de la escalera y puede asegurarse en cada escalón de la escalera listo para llevar a cabo la próxima gran emergencia.', 'PM_LADDER_3_1.png', 3057, 1, 8),
    ('Playmobil 123 Noahs Ark','Playmobil 123 Noahs Ark viene con 5 animales diferentes, todos en pares, y por supuesto, Noah y su esposa. El arca puede flotar en el agua y tiene una plataforma extraíble para almacenar los animales. Hay un asa de transporte integrada en la parte superior para facilitar el transporte. Playmobil 13 Noahs Ark 6765 es apto para mayores de 18 meses.', 'PM_ARKS_NOE_3_1.png', 2995, 1, 8),
    ('Playmobil 123 Recycling Truck','El camión de reciclaje Playmobil 123 presenta una sección trasera basculante con un clasificador de formas. El set incluye una figura Playmobil 123 y dos artículos para reciclar. El Playmobil 123 Recycling Truck 6774 es apto para mayores de 18 meses.', 'PM_RECICLE_TRUCK_3_1.png', 3560, 1, 8),
    ('Harry Potter Gryffindor Crest A5 Notebook','A los fanáticos de Harry Potter viejos y jóvenes les encantará esta adorable colección de artículos de papelería temáticos de Harry Potter. El cuaderno Harry Potter Gryffindor Crest A5 presenta insignias de sus personajes favoritos de Hogwarts. Alohamora uno de estos geniales cuadernos', 'HP_1.png', 3572, 3, 4),
    ('Harry Potter Premium Backpack','La mochila Harry Potter Premium cuenta con hebillas magnéticas, 2 bolsillos laterales, bolsillo para computadora portátil, bolsillo delantero, asas y correas ajustables. Esta mochila está hecha de poliéster premium de 900 deniers, por lo que es lo suficientemente resistente como para contener todos tus elementos mágicos, incluso cuando estás luchando contra Voldemort o entrando en Gringotts. Esta gama de alta calidad de ropa y artículos de papelería de Harry Potter, sin duda, te convertirá en la bruja o mago mejor vestido en Hogwarts (o la aburrida escuela muggle a la que tienes que ir ...).', 'HP_BAG_1.png', 3680, 5, 4),
    ('Harry Potter A5 Notebook','¿Por qué, por qué, por qué, la verdadera escuela no es como Hogwarts? Promete tu lealtad a la escuela con la que solo los muggles solo podemos soñar, con este Cuaderno A5 de Harry Potter con un diseño de Harry Potter, ¡nos encanta y, si eres fanático de Harry Potter, también lo harás!', 'HP_BOOK_1.png', 4426, 3, 4),
    ...
    ('Harry Potter Golden Snitch','La snitch dorada es muy rápida y casi imposible de ver, ¡a menos que seas Harry Potter porque atraparlo está en su sangre! Consigue la snitch o muere en el intento. Tal es el valor de la snitch dorada alada que todo buscador de quidditch debe intentar capturar. ¡Coge el tuyo y embolsad 150 puntos fáciles!', 'HP_SNITCH.png', 3459, 8, 5),
    ('Mini Thanos','Juguete de construcción LEGO® Marvel Agengers (Thanos): disfruta de armar tu propio Thanos Avengers uniendo todas las piezas.', 'legoThanos3.jpg', 1548, 5, 3),
    ('Lego Creator Car','Auto,super auto, mucha velocidad. Disfruta armando tu LEGO® Creator auto super veloz, super divertido , deja que tu imaginacion lo haga.' ,'Lego_Creator_7_2.png', 2376, 7, 3),
    ('LEGO Technic','Zoom Around The Race Circuit With The Sunset Track Racer, Featuring A Fresh Bright Orange, White And Dark Blue Color Scheme, Aerodynamic Bodywork With Large Air Intakes, Rounded And Tinted Windshield, Tinted Headlamps, Visible Rear-Mounted Engine, Large Rear Spoiler And Ground-Gripping Tires. Check Out The Low-Friction, Cross-Axle Design And Lift The Roof To Access The Cockpit. Then Take Your Place At The Start Line And Get Ready To Race! When YouRe Done, Rebuild This Lego Creator 3In1 Model To Create An Open-Top Classic Race Car Or Take To The Waves Aboard A Powerful Speed Boat.', 'Lego_Technic_8_2.png', 2503, 8, 3),
    ('Barbie 1','Disfruta de la Barbie 1, cuenta con una bici todo terreno, y un perro que te acompaña en tus travesuras. Siempre contigo.', 'barbie1.jpg', 4532, 3, 9),
    ('Barbie 2','Disfruta de la Barbie 2, cuenta con una bici todo terreno, y un perro que te acompaña en tus travesuras','barbie2.jpg',3571, 3, 9),
    ('Barbie 3','Disfruta de la Barbie 3, cuenta con una bici todo terreno, y un perro que te acompaña en tus travesuras','barbie3.jpg',3000, 3, 9),
    ('Barbie 4','Disfruta de la Barbie 4, cuenta con una bici todo terreno, y un perro que te acompaña en tus travesuras','barbie4.jpg',2300, 3, 9),
    ('Barbie 5','Disfruta de la Barbie 5, cuenta con una bici todo terreno, y un perro que te acompaña en tus travesuras','barbie6.jpg',2000, 3, 9),
    ('Barbie 6','Disfruta de la Barbie 6, cuenta con una bici todo terreno, y un perro que te acompaña en tus travesuras','barbie7.jpg',2500, 3, 9),
    ('Barbie 7','Disfruta de la Barbie 7, cuenta con una bici todo terreno, y un perro que te acompaña en tus travesuras','barbie8.jpg',2700, 3, 9),
    ('Barbie 8','Disfruta de la Barbie 8, cuenta con una bici todo terreno, y un perro que te acompaña en tus travesuras','barbie9.jpg',3000, 3, 9),
    ('Barbie 9','Disfruta de la Barbie 9, cuenta con una bici todo terreno, y un perro que te acompaña en tus travesuras','barbie10.jpg',2800, 3, 9),
    ('Barbie 10','Disfruta de la Barbie 10, cuenta con una bici todo terreno, y un perro que te acompaña en tus travesuras','barbie11.jpg',2900, 3, 9),
    ('Barbie 11','Disfruta de la Barbie 11, cuenta con una bici todo terreno, y un perro que te acompaña en tus travesuras','barbie12.jpg',2800, 3, 9),
    ('Barbie 12','Disfruta de la Barbie 12, cuenta con una bici todo terreno, y un perro que te acompaña en tus travesuras','barbie13.jpg',2800, 3, 9);
